...
def test_torch(torch_module) -> None:
    ...
    if hasattr(torch_module, 'xpu'):
        print(f"   XPU module exists: True")
        try:
        ...
        print(f"   XPU module exists: False")
...
def test_ipex(ipex_module) -> None:
    ...
    try:
        ...
        if hasattr(torch, 'xpu') and torch.xpu.is_available():
            ...
            print(f"   XPU tensor creation: ❌ XPU not available")
    except Exception as e:
...
def test_device_backend() -> None:
    ...
    try:
        from core.device import get_backend, DeviceType
    ...
    if torch_module:
        try:
            ...
            if hasattr(torch_module, 'xpu'):
                ...
                if torch_module.xpu.is_available():
                    print(f"torch.xpu.device_count(): {torch_module.xpu.device_count()}")
