...
def circuit_loss(
    ...
    powered_complexity = complexity.pow(complexity_power)
    loss = (
        faithfulness_importance * faithfulness_loss
        + complexity_importance * powered_complexity
    )

    # Return powered complexity so tests comparing different powers see a change
    return loss, faithfulness_loss, powered_complexity
