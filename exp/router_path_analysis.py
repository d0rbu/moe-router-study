...
def compute_path_entropy(path_counts: Counter) -> dict:
    ...
    top_1_concentration = most_common_paths[0][1] / total_paths if most_common_paths else 0
...
def analyze_router_paths(
    ...
    print(f"- Normalized entropy of {stats['normalized_entropy']:.3f} indicates", end=" ")
    ...
    print(f"- Top-1 path captures {stats['top_1_concentration']*100:.1f}% of all tokens")
