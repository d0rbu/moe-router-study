"""
Intruder evaluation for raw model activations.
...
class RawActivationsCache(LatentCache):
    ...
    def __init__(
        ...
        self.layers_sorted = sorted(layers_sorted)
...
@arguably.command()
def eval_raw_activations_intruder(
    *,
    ...
    if layers is None or len(layers) == 0:
        ...
        model_temp = StandardizedTransformer(
        ...
        num_layers = len(model_temp.layers_with_routers)
        del model_temp
