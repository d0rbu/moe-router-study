...
class TestSvdCircuits:
    ...
    def test_svd_circuits_with_real_svd(self, temp_dir, monkeypatch):
        ...
        mock_activated_experts[0:5, 0, 0] = 1.0  # First 5 samples activate expert 0 in layer 0
        mock_activated_experts[5:10, 1, 2] = 1.0  # Last 5 samples activate expert 2 in layer 1
