...
class TestClusterCircuits:
    ...
    def test_cluster_circuits_basic(self, capsys):
        ...
        mock_activations[0:3, 0, 0] = True  # First 3 samples activate expert 0 in layer 0
        mock_activations[4:7, 1, 2] = True  # Samples 4-6 activate expert 2 in layer 1
        mock_activations[8:10, 2, 3] = True  # Last 2 samples activate expert 3 in layer 2
    ...
    def test_cluster_circuits_with_real_dbscan(self):
        ...
        mock_activations[0:10, 0, 0] = True  # First 10 samples activate expert 0 in layer 0
        mock_activations[10:20, 1, 1] = True  # Last 10 samples activate expert 1 in layer 1
