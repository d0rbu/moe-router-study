...
class TestComputeAllCentroidsFromAssignments:
    ...
    async def test_basic_computation(self):
        ...
        new_centroids, weights = await compute_all_centroids_from_assignments(
    ...
    @pytest.mark.asyncio
    async def test_single_point_per_cluster(self):
    ...
    @pytest.mark.asyncio
    async def test_all_points_same_cluster(self):
    ...
    @pytest.mark.asyncio
    async def test_large_scale(self):
    ...
    @pytest.mark.asyncio
    async def test_dtype_preservation(self):
        """Test that data types are preserved correctly."""
        # Test with float64
        data_f64 = th.tensor([[1.0, 2.0], [3.0, 4.0]], dtype=th.float64)
        assignments = th.tensor([0, 1], dtype=th.int64)

        centroids_f64, weights = await compute_all_centroids_from_assignments(
        ...
        centroids_f16, weights = await compute_all_centroids_from_assignments(
    ...
    @pytest.mark.asyncio
    async def test_cuda_device(self):
    ...
    async def test_numerical_stability(self):
        ...
        centroids_large, _ = await compute_all_centroids_from_assignments(
        ...
        centroids_small, _ = await compute_all_centroids_from_assignments(
    ...
    @pytest.mark.asyncio
    async def test_scatter_add_correctness(self):
