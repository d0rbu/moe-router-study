...
class TestGetExperimentName:
    ...
    def test_with_additional_params(self):
        ...
        result = get_experiment_name(
            "model1", "dataset1", learning_rate=0.001, batch_size=32
        )
    ...
    def test_parameter_sorting(self):
        ...
        result = get_experiment_name("model", "data", z_param=1, a_param=2, m_param=3)
    ...
    def test_ignored_keys(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            result = get_experiment_name(
                "model", "data", device="cuda", resume=True, learning_rate=0.01
            )
    ...
    def test_underscore_prefixed_keys(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            result = get_experiment_name(
                "model", "data", _private_param=123, public_param=456
            )
    ...
    @pytest.mark.parametrize(
        "model_name,dataset_name,expected",
        [
