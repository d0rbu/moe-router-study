...
uv run python -m exp.eval_all_paths eval-all-paths --experiment-dir "$1" --saebench-batchsize 16 --intruder-batchsize 4 --intruder-n-tokens 1000000 --log-level TRACE --skip-autointerp
