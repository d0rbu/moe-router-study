...
# Usage: ./run_router_path_entropy_local.sh [experiment_name] [batch_size]
...
uv run viz/router_path_entropy.py router-path-entropy --experiment-name "$EXPERIMENT_NAME" --batch-size "$BATCH_SIZE"
